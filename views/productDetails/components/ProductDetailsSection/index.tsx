...
export function ProductDetailsSection({ flower }: Props) {
    return (
        <section className="flex py-8">
            <div>
                <GroupImages
                    idProduct={flower._id}
                    dscto={flower.dscto}
                    imgs={flower.imgs}
                />
            </div>
            <div className="flex flex-col px-8">
                ...
                <div className="flex items-center py-4 ">
                    ...
                    <p className="text-gray-500 underline ml-4">
                        (1 customer review)
                    </p>
                </div>
                <p>{flower.descripcion}</p>
                <p>{flower.detalles}</p>
                <ListDetailsFlower
                    categories={flower.categorias}
                    idFlower={flower._id}
                    stock={flower.stock}
                />
                <ContainerPricingFlower
                    producto={flower}
                ...
                <NavActionsFlower />
                <TabFlowerSection
                    contenido={flower.descripcion}
                    origen={flower.detalles}
                />
            </div>
        </section>
    )
