...
export const CardProduct = ({ flower }: Props) => {
    return (
            ...
            <div className="flex justify-between flex-1 p-8">
                <div className="flex flex-col justify-between ">
                    <div className="flex flex-col pb-4">
                        ...
                        <p className="text-sm my-2 max-w-sm">
                            {flower.descripcion}
                        </p>
                        <div className="flex">
                    ...
                    <ul className="text-gray-400 flex-1 flex flex-col justify-around">
                        <li className="flex">
                            <label htmlFor={flower._id + '-frescura'}>
                                Frescura
                            </label>
                            <p id={flower._id + '-frescura'}>
                                <em className="text-red-700 ml-8 ">New</em>
                                (Aromáticas)
                            </p>
                        </li>
                        <li className="flex">
                            <label htmlFor={flower._id + '-tienda'}>
                                Tienda
                            </label>
                            <p
                                className="ml-8"
                                id={flower._id + '-tienda'}
                            >
                                Grocery Tarm Fields
                            </p>
                        </li>
                        <li className="flex">
                            <label htmlFor={flower._id + '-delivery'}>
                                Delivery
                            </label>
                            <p
                                className="ml-8"
                                id={flower._id + '-delivery'}
                            >
                                Toda la ciudad
                            </p>
                        </li>
                ...
                <div className="flex flex-col justify-between">
                    <div className="flex flex-col">
                        <p className="font-bold text-xl">
                            {flower.precioFinal.toFixed(2)} PEN
                        </p>
                        <p className="line-through text-gray-400">
                            {flower.precioInicial.toFixed(2)} PEN
                        </p>
                    </div>
