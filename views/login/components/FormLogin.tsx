            ...
            <Card>
                ...
                <CardBody className="grid gap-4">
                    ...
                    <article className=" flex justify-end">
                        <Link href="/">
                            <a className="text-xs text-red-400 ">
                ...
                >
                    ...
                    <span
                        ...
                        className=" cursor-pointer flex items-center rounded justify-around p-2 border-gray-300 border"
                    >
                        <FcGoogle />
                    ...
                    <span
                        ...
                        className=" cursor-pointer flex text-sky-500 items-center rounded justify-around p-2 border-gray-300 border"
                    >
                        <BsTwitter />
                    ...
                    <span
                        ...
                        className=" cursor-pointer flex text-sky-700 items-center rounded justify-around p-2 border-gray-300 border"
                    >
                        <BsFacebook />
