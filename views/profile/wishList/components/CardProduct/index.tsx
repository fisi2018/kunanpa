...
export function CardProduct({ item, mutate }: Props) {
    return (
            ...
            <CardBody className="gap-4 grid grid-cols-1 place-items-center ">
                ...
                <div className="flex flex-col items-center ">
                    ...
                    <Typography
                        ...
                        variant="small"
                    >
                        S/.{item.precioInicial.toFixed(2)}
                    </Typography>
                </div>
            </CardBody>
            <CardFooter
                divider
                className="grid relative grid-cols-1 gap-4 place-items-center place-content-center "
            >
                <Link
                    href={'/flores/' + item._id}
                    passHref
                >
                    <Button
                        color="red"
