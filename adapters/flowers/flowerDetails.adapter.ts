...
export const createFlowerDetailsAdapter = (response:FlowerDetailsResponse):FlowerDetails => {
  return {
    ...
    categorias: response.data.categorias.map((category) => ({ _id: category.id, name: category.nombre })),
