        ...
        <div className="grid grid-cols-4 gap-2 grid-flow-row p-2">
            ...
            <div className="row-span-2 col-span-2 flex justify-between flex-col ">
                ...
                <article className="flex ">
                    <label
                        ...
                        htmlFor={producto._id + '-' + producto.name}
                    >
                        Granja:{' '}
                    </label>
                    <p
                        className="text-sm"
                        id={producto._id + '-' + producto.name}
                    >
                        Tharamis Farm
                    </p>
                </article>
            ...
            <div className="row-span-3 flex text-sm justify-center items-center ">
                <div className="flex flex-col items-center">
                    <span
                        onClick={() => {
                            dispatch(
                                addSameProduct({
                                    ...
                                    initialPrice: producto.initialPrice,
                                    quantity: 1
                                })
                            )
                            return swal(
                        ...
                        className="flex cursor-pointer justify-center transition-color duration-300 ease-in-out items-center rounded-full hover:bg-red-700 hover:text-white "
                    >
                        <IoIosArrowUp />
                    </span>
                    ...
                    <span
                        onClick={() => {
                            ...
                            return swal(
                                'Producto eliminado',
                                'Un producto ha sido removido del carrito',
                                'success'
                            )
                        }}
                        className=" cursor-pointer rounded-full flex justify-center transition-color duration-300 ease-in-out items-center hover:bg-red-700 hover:text-white"
                    >
                        <IoIosArrowDown />
                    </span>
                </div>
            ...
            <div className="flex col-span-2 flex-col justify-between ">
                <p className="font-bold text-red-700 text-lg">
                    {producto.price.toFixed(2)} PEN
                </p>
                <p className="line-through text-sm text-gray-400">
                    {producto.initialPrice.toFixed(2)} PEN
                </p>
            </div>
        </div>
    )
